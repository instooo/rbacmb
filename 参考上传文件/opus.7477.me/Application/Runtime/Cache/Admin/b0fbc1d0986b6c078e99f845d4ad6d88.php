...
<head>
    ...
    <title>精品素材</title>
    <meta name="keywords" content="精品素材"/>
    <meta name="description" content="精品素材"/>
...
<!-- header end -->
<div id="wrapper">
    <form id="form" method="get" action="<?php echo U('media/bestMedia');?>">
