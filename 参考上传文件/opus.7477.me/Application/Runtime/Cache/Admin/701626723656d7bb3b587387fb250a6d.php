...
<head>
  ...
  <title><?php echo W('Common/title');?></title>
  <meta name="keywords" content="<?php echo W('Common/title');?>" />
  <meta name="description" content="<?php echo W('Common/title');?>" />
...
<script type="text/javascript" src="/Public/Admin/js/header.js"></script> 
  <!-- header end -->
  <div id="wrapper">
    <form id="form" method="get" action="<?php echo U('media/myMedia');?>">
      <?php if(is_array($where)): foreach($where as $key=>$vo): ?><input type="hidden" name="<?php echo ($key); ?>" value="<?php echo ($vo); ?>"><?php endforeach; endif; ?>
