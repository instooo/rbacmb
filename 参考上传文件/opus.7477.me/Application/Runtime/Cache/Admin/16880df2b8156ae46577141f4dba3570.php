...
<head>
    ...
    <title><?php echo ($other); ?>的审核通过作品</title>
    <meta name="keywords" content="<?php echo ($other); ?>的审核通过作品" />
    <meta name="description" content="<?php echo ($other); ?>的审核通过作品" />
...
<!-- header end -->
<div id="wrapper">
    <form id="form" method="get" action="<?php echo U('media/otherMedia');?>">
              ...
              <i></i>
                ...
                <div class="filter clearfix">
                    ...
                    <div class="row-list fl">
                        ...
                        <input type="text" class="txt fl"   name="game" value="<?php echo ($_GET['game']); ?>" style="padding: 0 10px;height: 26px;line-height: 26px;border: 1px #e4e4e6 solid;-webkit-border-radius: 1px;border-radius: 1px; margin-right: 10px;text-align: center;">
